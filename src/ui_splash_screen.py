    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(
            QCoreApplication.translate(
                "SplashScreen",
                u'<html><head/><body><p><span style=" font-weight:600;">CRYPTOME</span></p></body></html>',
                None,
            )
        )
        self.label_description.setText(
            QCoreApplication.translate(
                "SplashScreen",
                u"<html><head/><body><p>Face detection semester 6 project</p><p><br/></p></body></html>",
                None,
            )
        )
        ...
        self.label_credits.setText(
            QCoreApplication.translate(
                "SplashScreen",
                u"<html><head/><body><p>Created by : VsR | Monarch | Qhazi</p></body></html>",
                None,
            )
        )
